...
<head>
<script type="text/x-mathjax-config"> MathJax.Hu<div style="overflow-x: auto;">
$$
\begin{align}
k_x a &= \frac{m\pi}{2} + \frac{1}{2}\tan^{-1}(\frac{\gamma}{k_x}) + \frac{1}{2}\tan^{-1}(\frac{\sigma}{k_x}) \\
\phi &= \frac{m\pi}{2} + \frac{1}{2}\tan^{-1}(\frac{\gamma}{k_x}) - \frac{1}{2}\tan^{-1}(\frac{\sigma}{k_x}) \tag{16}
\end{align}
$$
</div>({ TeX: { equationNumbers: { autoNumber: "all" } } }); </script>
...
\text{with} \quad k_{x,i} &= \sqrt{k^2 n_i^2 - \beta^2} \tag{14}
\end{align}
$$
</div>
...
where $k_x, \sigma, \gamma$ is wavenumbers along x-axis in each regions and are given by eq.14

...
$$
\begin{align}
\nabla^2 \psi + (n^2 k^2 - \beta^2) \psi = 0 \tag{9}
\end{align}
$$
</div>
...
$\[
\vec{E}(x,y,z)=\sum\limits_{m} a_m \vec{E}_m(x,y)e^{-i\beta_m z} + \int a(k) \vec{E}_k(x,y)e^{-ikz} \, dk
\]$
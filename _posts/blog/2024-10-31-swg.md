...
E_y(x) = \left\{
\begin{aligned}
&A \cos \left( \kappa a - \phi \right) \exp{-\sigma (x - a)}, \quad &x > a \\
&A \cos \left( \kappa x - \phi \right), \quad &|x| \leq a \\
&A \cos \left( \kappa a + \phi \right) \exp{\gamma (x + a)}, \quad &x < -a
\end{aligned}
\right.
&&
\end{align*}
...
$$
\begin{align*}
\kappa a &= \frac{m\pi}{2} + \frac{1}{2}\arctan{\frac{\gamma}{\kappa}} + \frac{1}{2}\arctan{\sigma}}{\kappa}
phi &= \frac{m\pi}{2} + \frac{1}{2}\arctan{\frac{\gamma}{\kappa}} - \frac{1}{2}\arctan{\sigma}}{\kappa}
\end{align*}
$$
</div>

for the symmetric case($n_0 = n_s$)
